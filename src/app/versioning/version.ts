...
export const CHANGELOG: Record<string, ChangelogEntry> = {
  "3.0.0": {
    ...
    fixed: [
      ...
      "First-person asterisk actions in RP turns (e.g. *I roll my eyes.*) use the character voice instead of the narrator saying the character name before each beat; third-person beats with another subject (e.g. Dad grabs my arm) stay on the narrator",
