...
export function buildStoryChatContext({
  ...
  const sceneGuidance = normalizeWhitespace(
    [
      ...
      "- Each character block must be substantial. Do not write single-sentence or two-word reaction lines like 'Jake: \"The scope.\"' or 'Amy: \"We have a lot of material.\"' on their own. A character's turn should contain multiple sentences — dialogue, internal reaction, follow-up thought, or action — before switching speakers. Here is a concrete example of the correct format:",
      "",
      "Jake:",
      "*leans back in his chair and stares at the ceiling for a moment*",
      ...
      "\"I think he suspects there's a conversation. I don't think he has full intelligence on the scope of it.\" *pauses* \"Which is probably good. For everyone involved.\"",
      "",
      "Narrator:",
      "The refrigerator hums. Neither of them reaches for their coffee.",
      "",
      "- That is the correct format. Do not collapse a character's contribution into a single line.",
    ].join("\n"),
  );
