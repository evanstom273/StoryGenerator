...
export function buildStoryChatContext({
  ...
  const sceneGuidance = normalizeWhitespace(
    [
      ...
      "- In Narrator blocks, refer to known characters by name (e.g. Holt, Jake, Amy), not only by titles or ranks (Captain, Sergeant, Detective) unless the scene is explicitly formal.",
