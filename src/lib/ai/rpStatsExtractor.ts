...
export async function extractRpStatChanges(
  ...
  const prompt = [
    ...
    "",
    "NPC INNER LIFE:",
    "Whenever a named character appears in the scene — even if the player character is not physically present — include an entry in \"npcInnerLifeUpdates\": [{\"characterName\": \"...\", \"tier\": \"...\", \"emotionalState\": \"...\", \"howTheyDescribeYou\": \"...\", \"whatTheyWant\": \"...\", \"whatTheyreNotSaying\": \"...\"}].",
    "- tier: REQUIRED. The relationship type. Use one of: devoted, lover, partner, best friend, confidant, close friend, friend, family, mentor, mentee, caregiver, patient, ally, colleague, professional, acquaintance, stranger, complicated, guarded, distant, estranged, rival, adversary, enemy, nemesis, threat.",
    "- emotionalState: REQUIRED. 2-5 words for how this character privately feels about the player character right now. Infer from the scene, dialogue tone, and context (e.g. \"quietly worried\", \"proud but unsure\", \"deeply protective\"). Always write something.",
    "- howTheyDescribeYou: REQUIRED. One sentence in their internal voice about how they see the player character (e.g. \"He's brilliant but I can't reach him\", \"She tries so hard and it breaks my heart\"). Always write something.",
    "- whatTheyWant: Optional. What they privately want from this relationship right now.",
    "- whatTheyreNotSaying: Optional. Something meaningful they are actively holding back.",
    "- Omit the array entirely only if absolutely no named character appeared in the scene.",
    "",
    "RELATIONSHIP ARC:",
    "Whenever a named character appears in the scene — even if the player character is not physically present — include an entry in \"arcUpdates\": [{\"characterName\": \"...\", \"tier\": \"...\", \"statusPhrase\": \"...\", \"newMilestone\": \"...\", \"tension\": \"...\"}].",
    "- tier: REQUIRED. Same values as NPC INNER LIFE tier.",
    "- statusPhrase: REQUIRED. 3-6 evocative words capturing the current feel of this relationship (e.g. \"fragile but warming\", \"tested and holding\", \"quietly devoted\", \"at a crossroads\"). Always write something.",
    "- tension: REQUIRED if there is any unresolved dynamic. The central unresolved question or conflict (e.g. \"Will he ever open up to them?\", \"Can they reach him before he shuts down?\").",
    "- newMilestone: Optional. ONLY on genuinely milestone-worthy events. 3-6 words.",
    "- Omit the array entirely only if absolutely no named character appeared in the scene.",
    "",
