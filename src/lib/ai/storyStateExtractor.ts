...
export function buildStoryStateExtractionPrompt({
  ...
  const system = normalizeWhitespace(
    [
      ...
      '    "relationships"?: Array<{ "a": string, "b": string, "friendship"?: number, "trust"?: number, "respect"?: number, "loyalty"?: number, "tension"?: number, "hostility"?: number, "summary"?: string, "evidence"?: { "messageNumbers": number[] } }>,',
