		...
		},
		{
			...
			blocks: [
				...
				},
				{
					type: "bullets",
					items: [
						"Generate Response / Generate Direction — AI suggests your next turn. Before any scenes exist it proposes player dialogue or action; once scenes exist it defaults to a Director staging note with full transcript context (you can edit before sending).",
